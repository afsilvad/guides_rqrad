...
![Anaconda navigator. Source : [Site web Anaconda (cliquez dessus pour l'agrandir)](https://www.anaconda.com/docs/legacy/anaconda-navigator/main)](images/04_01_conda_navigator.webp){width=90%}
...
![Fenêtre Anaconda Prompt, utilisée pour exécuter les commandes conda sur Windows (cliquez dessus pour l'agrandir)](images/04_02_anaconda_prompt){width=90%}
