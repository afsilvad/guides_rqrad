...
![Menu de création d'un codespace à partir du bouton **Code** du dépôt (cliquez dessus pour l'agrandir)](images/02_01_codespaces_repository.png){width=90%}
...
![Tableau de bord de GitHub Codespaces et gabarits de démarrage rapide (cliquez dessus pour l'agrandir)](images/02_02_github_codespaces.png){width=90%}
...
- **Clavardage avec un agent (Chat)** : un panneau, généralement affiché à droite, pour poser des questions sur le code ou déléguer une tâche à un agent IA (comme GitHub Copilot). Deux modes principaux sont proposés : **Ask**, pour poser une question ou obtenir une explication, et **Agent**, pour laisser l'IA modifier le code de façon autonome selon une tâche décrite [[5](#ref-5)].

Pour ouvrir le terminal s'il n'est pas visible, utilisez le menu **Terminal > New Terminal**. Pour ouvrir le clavardage, cliquez sur l'icône de conversation dans la barre d'activité, ou utilisez le raccourci **Ctrl + Alt + I** (Windows/Linux) ou **Cmd + Option + I** (Mac) [[5](#ref-5)].

![Interface Visual Studio Code dans GitHub Codespaces  (cliquez dessus pour l'agrandir)](images/02_03_github_codespaces){width=90%}
...
- Reconnaître les éléments principaux de l'interface Visual Studio Code dans le navigateur, y compris le panneau de clavardage avec un agent IA.
...
::: {#ref-5}
5\. Visual Studio Code — [Use chat in VS Code](https://code.visualstudio.com/docs/chat/chat-overview)
:::
