...
![Interface de Spyder](images/05_01_spyder_interface.png){width=90%}
...
![Sélection de l'interpréteur Python dans les préférences de Spyder](images/05_02_select_env.png){width=90%}
